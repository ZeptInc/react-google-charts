...
var _jsxFileName = '/home/bridge/work/react-google-charts/src/components/Chart.js';
...
var Chart = function (_React$Component) {
  ...
  Chart.prototype.componentDidMount = function componentDidMount() {
    ...
    if (this.props.loadCharts) {
      __WEBPACK_IMPORTED_MODULE_4__GoogleChartLoader__["a" /* default */].init(this.props.chartPackages, this.props.chartVersion, this.props.mapsApiKey).then(function () {
        _this2.drawChart();
      });
...
Chart.propTypes = {
  ...
  chartEvents: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    ...
    callback: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func // eslint-disable-line react/no-unused-prop-types
  })),
  chartActions: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    ...
    action: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func // eslint-disable-line react/no-unused-prop-types
  })),
  ...
  mapsApiKey: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  numberFormat: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    ...
    options: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
      ...
      suffix: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string // eslint-disable-line react/no-unused-prop-types
    })
  }),
  dateFormat: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    ...
    options: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
      ...
      pattern: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string, // eslint-disable-line react/no-unused-prop-types
      timeZone: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number // eslint-disable-line react/no-unused-prop-types
    })
  }),
  diffdata: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    ...
    off: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array // eslint-disable-line react/no-unused-prop-types
  })
};
  ...
  init: function init(packages, version, mapsApiKey) {
    ...
    this.initPromise = new Promise(function (resolve) {
      script('https://www.gstatic.com/charts/loader.js', { success: function success() {
          var opts = { packages: packages || ['corechart'] };
          if (mapsApiKey) {
